...
# class PharmacyManagementSystem:
    def open_firstpage_window(self):
        ...
        img1=Image.open("C:/Users/meetp/OneDrive/Desktop/new(mini qr code project generator)/Logo/logo.png")
...
#---------------here right side showing--------------------------------------------------------
        ...
        # img2=Image.open("C:/Users/meetp/anaconda3/Lib/tkinter/1.jpg")
        img2=Image.open("C:/Users/meetp/OneDrive/Desktop/new(mini qr code project generator)/medicine_photos/medicine-tablets.jpeg")
        img2=img2.resize((314,213),Image.Resampling.LANCZOS)
        self.photoimg2=ImageTk.PhotoImage(img2)
        b1=Button(self.root,image=self.photoimg2,borderwidth=0)
        b1.place(x=40,y=580)

        # img3=Image.open("C:/Users/meetp/anaconda3/Lib/tkinter/2.jpg")
        img3=Image.open("C:/Users/meetp/OneDrive/Desktop/new(mini qr code project generator)/medicine_photos/medicine-syrup.jpeg")
        ...
        # img5=Image.open("C:/Users/meetp/anaconda3/Lib/tkinter/4.jpg")
        img5=Image.open("C:/Users/meetp/OneDrive/Desktop/new(mini qr code project generator)/medicine_photos/medicine-injection.jpeg")
        img5=img5.resize((340,213),Image.Resampling.LANCZOS)
        self.photoimg5=ImageTk.PhotoImage(img5)
        b1=Button(self.root,image=self.photoimg5,borderwidth=0)
        b1.place(x=742,y=580)

        # img6=Image.open("C:/Users/meetp/anaconda3/Lib/tkinter/5.jpg")
        img6=Image.open("C:/Users/meetp/OneDrive/Desktop/new(mini qr code project generator)\medicine_photos/medicine-ointment.jpeg")
        img6=img6.resize((350,213),Image.Resampling.LANCZOS)
        self.photoimg6=ImageTk.PhotoImage(img6)
        b1=Button(self.root,image=self.photoimg6,borderwidth=0)
        b1.place(x=1115,y=580)

        # img7=Image.open("C:/Users/meetp/anaconda3/Lib/tkinter/6.jpg")
        img7=Image.open("5.jpg")
        img7=img7.resize((300,213),Image.Resampling.LANCZOS)
        self.photoimg7=ImageTk.PhotoImage(img7)
        b1=Button(self.root,image=self.photoimg7,borderwidth=0)
        b1.place(x=1220,y=580)
...
# #-------------------------------------------------------------------------------------------------------------------------------------
    ...
    def get_data(self,event=''):
        ...
        # self.ref_combo.set(row[14])
        # self.comp_combo.set(row[13])
        # self.type_medicine_combo.set(row[17])
        # self.med_combo.set(row[14])
        # self.lotno_combo.set(row[9])
        # self.entry_issue.set(row[18])
        # self.entry_expiry.set(row[12])
        # self.use_combo.set(row[5])
        # self.tablet_combo.set(row[14])
        # self.product_QT_combo.set(row[12])
...
# -------------------------------for GST data box only-----------------------------------------------------------------
        ...
        # self.entry_net_amount=Entry(DataFrameMiddle_down,textvariable=self.neting,width=12,bd=2,
        #                             font=("arial",15,),relief=RIDGE,state="readonly")
        # # self.entry_net_amount.place(x=132,y=69)
        # self.entry_net_amount.grid(row=2,column=1)
...
# ----------------------------------for invoice generate button only------------------------------------------------
    ...
    def multiply(self):
        ...
        self.entry_total_amount.delete(0, END)  # clear any previous value in the Entry widget
        self.entry_total_amount.insert(0, "Rs. "+str(self.medicine_total.get()))  # set the value of Entry widget to totalprice


        # print(self.medicine_total)

        # self.totalprice = ((self.medicine_tablet.get())*(self.medicine_product.get()))
        # self.medicine_total.set(str(self.totalprice))
        # print(self.medicine_total)
        # print(self.neting.set(str(self.totalprice)))

        # self.total_price = (float(self.xyz.get()) * (self.product_naming.get()))
        # self.neting_amount_total.set(str(self.total_price))
    ...
    def print_invoice(self):
        ...
        # folder_path = "C:/Users/meetp/OneDrive/Desktop/new(mini qr code project generator)/file_saved"    #/path/to/folder
